...
type
  TfRelPedidoProcesso2 = class(TForm)
    RLReport1: TRLReport;
...
var
  fRelPedidoProcesso2: TfRelPedidoProcesso2;
...
procedure TfRelPedidoProcesso2.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := Cafree;
end;

procedure TfRelPedidoProcesso2.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfRelPedidoProcesso2.RLBand4BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfRelPedidoProcesso2.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfRelPedidoProcesso2.FormCreate(Sender: TObject);
begin
  vVlrPendente := 0;
  {if fConsPedido2.CheckBox2.Checked then
