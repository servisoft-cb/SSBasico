object fEscNotaFiscalDevolPorItem2: TfEscNotaFiscalDevolPorItem2
  ...
  object qNotaFiscal: TQuery
    ...
    SQL.Strings = (
        ...
        'tEmissao, Dbnotafiscalitens.CodProduto, Dbproduto.Referencia, Db' +
        'notafiscal.CodCli, Dbproduto.Nome NomeProduto, Dbnotafiscalitens' +
        '.Item, Dbcliente.Nome NomeCliente, Dbnotafiscalitens.Qtd, Dbnota' +
        'fiscalitens.QtdRestante, Dbnotafiscalitens.QtdDevolvida, Dbnotaf' +
        'iscalitens.CodCor, Dbnotafiscalitens.Unidade, Dbnatoperacao.CodN' +
        'atOper, Dbnotafiscalitens.VlrUnit, Dbnotafiscalitens.VlrTotal, D' +
        'bnotafiscal.NumSeq'
