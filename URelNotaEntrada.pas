...
procedure TfRelNotaEntrada.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  QrLabel2.Caption := DM1.tFilialEmpresa.AsString + ' - ' + DM1.tFilialBairro.AsString;
  QrLabel3.Caption := 'Cep:' + DM1.tFilialCep.AsString + ' - Fone:' + DM1.tFilialTel.AsString + ' - Fax:' + DM1.tFilialFax.AsString;
end;
