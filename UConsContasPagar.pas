...
uses UDM1, URelCPagarPagto;


{$R *.DFM}

procedure TfConsContasPagar.Le_qParcelas;
var
  vTotal : Real;
begin
  vTotal := 0;
...
begin
  ...
  if RxDBLookupCombo2.Text <> '' then
    begin
      qParcelas.SQL.Add(' AND (dbCPagar.Filial = :Filial) ');
...
procedure TfConsContasPagar.RxSpeedButton1Click(Sender: TObject);
begin
  SMDBGrid1.DisableScroll;
