...
begin
  ...
  RLLabel3.Caption := '';
  if fPrevAcumuladoFat.RxDBLookupCombo1.Text <> '' then
    RLLabel3.Caption := RLLabel3.Caption + ' Filial: ' + fPrevAcumuladoFat.RxDBLookupCombo1.Text;
...
procedure TfRelAcumuladoFat.RLBand2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if fPrevAcumuladoFat.mAcumuladoNomeProduto.AsString = '...TOTAL DO CLIENTE' then
    begin
