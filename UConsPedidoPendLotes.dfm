object fConsPedidoPendLotes: TfConsPedidoPendLotes
  ...
  object qPendencias: TQuery
    ...
    SQL.Strings = (
        ...
        'tem.Plano, Dbpedidoitem.CodCor, Dbpedido.Tipo, Dbpedido.Filial, ' +
        'Dbcliente.Fantasia, Dbproduto.DescMaterial'
      ...
      'WHERE   (Dbpedidoitem.TalaoGerado = FALSE)  '
    ...
    object qPendenciasPlano: TStringField
      FieldName = 'Plano'
      Size = 30
    end
    ...
    object qPendenciasTipo: TStringField
      FieldName = 'Tipo'
      Size = 1
    end
    object qPendenciasFilial: TIntegerField
      FieldName = 'Filial'
    end
