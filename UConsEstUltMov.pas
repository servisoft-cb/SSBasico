...
begin
  if RxDBLookupCombo1.Text = '' then
    ...
    begin
      ...
      qMaterial.SQL.Add('   AND  (Filial = :Filial)');
      ...
      if CurrencyEdit1.AsInteger > 0 then
        begin
          ...
          qMaterial.ParamByName('Filial').AsInteger := RxDBLookupCombo1.KeyValue;
          qMaterial.Open;
          ...
          qOC.SQL.Add('Dbproduto.Codigo CodigoMat, Dbordemcompraitem.DtEntrega, Dbordemcompraitem.QtdRestante, Dbcor.Nome, Dbcor.Codigo CodCor, Dbordemcompraitem.Tamanho');
          ...
          qOC.SQL.Add('     AND (dbordemcompra.Filial = :Filial)');
          if fConsEstoqueMat.qEstoqueTamanho.AsString <> '' then
            begin
              qOC.SQL.Add('     AND (dbordemcompraitem.Tamanho = :Tamanho)');
              qOC.ParamByName('Tamanho').AsString := fConsEstoqueMat.qEstoqueTamanho.AsString;
            end;
          ...
          qOC.ParamByName('Filial').AsInteger := RxDBLookupCombo1.KeyValue;
          qOC.Open;
    ...
    begin
      if mEstoque.RecordCount > 0 then
        begin
          ...
          fConsHistMat.DateEdit1.Date            := vDataIni;
          ...
          fConsHistMat.RxDBLookupCombo4.KeyValue := qMaterialCodMaterial.AsInteger;
          ...
          if qMaterialCodCor.AsInteger > 0 then
            begin
              ...
              fConsHistMat.RxDBLookupCombo2.KeyValue := qMaterialCodCor.AsInteger;
            end;
          if qMaterialTamanho.AsString <> '' then
            fConsHistMat.RxDBLookupCombo3.KeyValue := qMaterialTamanho.AsString;
