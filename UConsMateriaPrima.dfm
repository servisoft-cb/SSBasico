object fConsMateriaPrima: TfConsMateriaPrima
  ...
  object tMaterial: TTable
    ...
    object tMaterialImpMatTalao: TBooleanField
    ...
    object tMaterialCodTipoProduto: TIntegerField
      FieldName = 'CodTipoProduto'
    end
    object tMaterialCodTipoMaterial: TIntegerField
      FieldName = 'CodTipoMaterial'
    end
    object tMaterialQtdVolume: TIntegerField
      FieldName = 'QtdVolume'
    end
    object tMaterialCodProcesso: TIntegerField
      FieldName = 'CodProcesso'
    end
    object tMaterialCodCSTIPI: TStringField
      FieldName = 'CodCSTIPI'
      Size = 2
    end
    object tMaterialTamCalculo: TFloatField
    ...
    object tMaterialLocalCorredor: TStringField
      FieldName = 'LocalCorredor'
      Size = 10
    end
    object tMaterialLocalPosicao: TStringField
      FieldName = 'LocalPosicao'
      Size = 25
    end
    object tMaterialCodCliente: TIntegerField
      FieldName = 'CodCliente'
    end
    object tMaterialCodSitCF: TStringField
      FieldName = 'CodSitCF'
      Size = 5
    end
    object tMaterialCodRepresentada: TIntegerField
      FieldName = 'CodRepresentada'
    end
    object tMaterialCodFabrica: TIntegerField
      FieldName = 'CodFabrica'
    end
    object tMaterialRefCliente: TStringField
      FieldName = 'RefCliente'
      Size = 25
    end
    object tMaterialCarimboSola: TStringField
      FieldName = 'CarimboSola'
      Size = 50
    end
    object tMaterialCarimboPalmilha: TStringField
      FieldName = 'CarimboPalmilha'
      Size = 50
    end
    object tMaterialFicha: TStringField
      FieldName = 'Ficha'
      Size = 30
    end
    object tMaterialConstrucao: TStringField
      FieldName = 'Construcao'
      Size = 30
    end
    object tMaterialForma: TStringField
      FieldName = 'Forma'
      Size = 30
    end
    object tMaterialTipoCodColecao: TIntegerField
      FieldName = 'TipoCodColecao'
    end
    object tMaterialTipoCodProdutoForn: TIntegerField
      FieldName = 'TipoCodProdutoForn'
    end
    object tMaterialTipoCodProduto: TIntegerField
      FieldName = 'TipoCodProduto'
    end
    object tMaterialTipoCodMaterial: TIntegerField
      FieldName = 'TipoCodMaterial'
    end
    object tMaterialTipoCodCor: TIntegerField
      FieldName = 'TipoCodCor'
    end
    object tMaterialEndArquivoCNC: TStringField
      FieldName = 'EndArquivoCNC'
      Size = 250
    end
    object tMaterialTipoCodMarca: TIntegerField
