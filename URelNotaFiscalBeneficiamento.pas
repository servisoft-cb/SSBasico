...
begin
  ...
  if fConsNotaFiscalBeneficiamento.RxDBLookupCombo1.Text <> '' then
    RLLabel5.Caption := RLLabel5.Caption + '   Filial: ' + fConsNotaFiscalBeneficiamento.RxDBLookupCombo1.Text
  else
    RLLabel5.Caption := RLLabel5.Caption + '   Filial: Todas';
