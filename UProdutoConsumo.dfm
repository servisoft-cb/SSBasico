object fProdutoConsumo: TfProdutoConsumo
  ...
  object mProdutoGrade: TMemoryTable
    ...
    object mProdutoGradeTamanhoMat: TStringField
      FieldName = 'TamanhoMat'
      Size = 6
    end
    object mProdutoGradelkTamanhoMat: TStringField
      FieldKind = fkLookup
      FieldName = 'lkTamanhoMat'
      LookupDataSet = qTamanho
      LookupKeyFields = 'Tamanho'
      LookupResultField = 'Tamanho'
      KeyFields = 'TamanhoMat'
      Size = 6
      Lookup = True
    end
  end
  ...
  object qTamanho: TQuery
    ...
    SQL.Strings = (
      'SELECT Dbprodutotam.Posicao, Dbgradeitem.Tamanho'
      'FROM "dbProdutoTam.DB" Dbprodutotam'
      '   INNER JOIN "dbGradeItem.DB" Dbgradeitem'
      '   ON  (Dbprodutotam.CodGrade = Dbgradeitem.CodGrade)  '
      '   AND  (Dbprodutotam.Posicao = Dbgradeitem.Posicao)  '
      'WHERE  Dbprodutotam.CodProduto = :CodProduto ')
    Left = 640
    Top = 72
    ParamData = <
      item
    ...
    object qTamanhoPosicao: TIntegerField
      FieldName = 'Posicao'
      Origin = 'TABELAS."dbProdutoTam.DB".Posicao'
    end
