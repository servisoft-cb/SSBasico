...
procedure TfRelFaturamento.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
 RLLabel1.Caption := 'RELATÓRIO FATURAMENTO - ' + fConsFaturamento.DateEdit1.Text + ' a '+ fConsFaturamento.DateEdit2.Text;
 RLLabel9.Caption := '';
