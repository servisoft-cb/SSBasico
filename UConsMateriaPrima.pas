...
type
  TfConsMateriaPrima = class(TForm)
    ...
    tMaterialImpMatTalao: TBooleanField;
    tMaterialComplemento: TStringField;
    tMaterialCodTipoProduto: TIntegerField;
    tMaterialCodTipoMaterial: TIntegerField;
    tMaterialQtdVolume: TIntegerField;
    tMaterialCodProcesso: TIntegerField;
    tMaterialCodCSTIPI: TStringField;
    tMaterialTamCalculo: TFloatField;
    tMaterialOrigemProd: TStringField;
    tMaterialLocalCorredor: TStringField;
    tMaterialLocalPosicao: TStringField;
    tMaterialCodCliente: TIntegerField;
    tMaterialCodSitCF: TStringField;
    tMaterialCodRepresentada: TIntegerField;
    tMaterialCodFabrica: TIntegerField;
    tMaterialRefCliente: TStringField;
    tMaterialCarimboSola: TStringField;
    tMaterialCarimboPalmilha: TStringField;
    tMaterialFicha: TStringField;
    tMaterialConstrucao: TStringField;
    tMaterialForma: TStringField;
    tMaterialTipoCodColecao: TIntegerField;
    tMaterialTipoCodProdutoForn: TIntegerField;
    tMaterialTipoCodProduto: TIntegerField;
    tMaterialTipoCodMaterial: TIntegerField;
    tMaterialTipoCodCor: TIntegerField;
    tMaterialEndArquivoCNC: TStringField;
    tMaterialTipoCodMarca: TIntegerField;
...
procedure TfConsMateriaPrima.Gera_MateriaPrima(CodProduto,CodCor,CodGrade,Posicao : Integer; QtdProduto : Real; Tamanho : String);
var
  vAux : Real;
begin
  ...
  if not DM1.tProdutoComb.Locate('CodCor;CodCombinacao',VarArrayOf([CodCor,fConsPedidoBR.qConsultaCodCombinacao.AsInteger]),[loCaseInsensitive]) then
    exit;
      ...
      while not fConsPedidoBR.qConsulta.Eof do
        begin
          ...
          if DM1.tProduto.Locate('Codigo',fConsPedidoBR.qConsultaCodProduto.AsInteger,([LocaseInsensitive])) then
            begin
              if fConsPedidoBR.tPedidoGrade.RecordCount > 0 then
                begin
                  fConsPedidoBR.tPedidoGrade.First;
                  while not fConsPedidoBR.tPedidoGrade.Eof do
                    begin
                      if fConsPedidoBR.tPedidoGradeQtdParesRest.AsFloat > 0 then
                        Gera_MateriaPrima(fConsPedidoBR.qConsultaCodProduto.AsInteger,fConsPedidoBR.qConsultaCodCor.AsInteger,
                                         fConsPedidoBR.tPedidoGradeCodGrade.AsInteger,fConsPedidoBR.tPedidoGradePosicao.AsInteger,
                                         fConsPedidoBR.tPedidoGradeQtdParesRest.AsFloat,fConsPedidoBR.tPedidoGradelkTamanho.AsString);
                      fConsPedidoBR.tPedidoGrade.Next;
                    end;
                end
              else
                Gera_MateriaPrima(fConsPedidoBR.qConsultaCodProduto.AsInteger,fConsPedidoBR.qConsultaCodCor.AsInteger,
                                 fConsPedidoBR.qConsultaCodGrade.AsInteger,fConsPedidoBR.qConsultaPosicao.AsInteger,
                                 fConsPedidoBR.qConsultaQtdParesRest.AsFloat,fConsPedidoBR.qConsultaTamanho.AsString);
            end;
