unit URelNotaBeneficiamentoAcum;
...
type
  TfRelNotaBeneficiamentoAcum = class(TForm)
    RLReport1: TRLReport;
    RLBand1: TRLBand;
    RLDBText1: TRLDBText;
...
var
  fRelNotaBeneficiamentoAcum: TfRelNotaBeneficiamentoAcum;
...
procedure TfRelNotaBeneficiamentoAcum.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := Cafree;
end;

procedure TfRelNotaBeneficiamentoAcum.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
