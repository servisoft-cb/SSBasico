...
type
  TfConsPedidoPendLotes = class(TForm)
    ...
    qPendenciasPlano: TStringField;
    BitBtn1: TBitBtn;
    qPendenciasCodCor: TIntegerField;
    qPendenciasTipo: TStringField;
    qPendenciasFilial: TIntegerField;
...
begin
  if (qPendencias.Active) and (qPendenciasFilial.AsInteger > 0) then
    begin
      fGeraLote.RxDBLookupCombo1.KeyValue := qPendenciasFilial.AsInteger;
      fGeraLote.CurrencyEdit1.AsInteger   := qPendenciasPedido.AsInteger;
      Close;
    end;
end;
