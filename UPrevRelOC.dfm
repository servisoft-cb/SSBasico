object fPrevRelOC: TfPrevRelOC
  ...
  object Panel1: TPanel
    ...
    object ComboBox2: TComboBox
      ...
      Items.Strings = (
        ...
        'C'#243'd. Material, Tamanho, Dt.Entrega'
        'C'#243'd. Material, Tamanho, Dt.Emiss'#227'o'
        'Nome Material, Tamanho, Dt. Entrega'
        'Nome Material, Tamanho, Dt. Emiss'#227'o'
  ...
  object qOrdem: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Dbordemcompra.Filial, Dbfornecedores.CodForn, Dbfornecedo' +
        'res.NomeForn, Dbordemcompra.Codigo NumOC, Dbcor.Nome NomeCor, Db' +
        'ordemcompraitem.CodMaterial, Dbproduto.Referencia, Dbproduto.Nom' +
        'e NomeMaterial, Dbordemcompraitem.CodCor, Dbordemcompraitem.Item' +
        ', Dbordemcompraitem.Qtd, Dbordemcompraitem.VlrUnitario, Dbordemc' +
        'ompraitem.DtEntrega, Dbordemcompraitem.VlrTotal, Dbordemcomprait' +
        'em.QtdEntregue, Dbordemcompraitem.QtdRestante, Dbordemcompraitem' +
        '.Tamanho, Dbordemcompraitem.QtdCancelada, dbOrdemCompra.DtEmissa' +
        'o'
      'FROM "dbOrdemCompra.DB" Dbordemcompra'
      '   INNER JOIN "dbOrdemCompraItem.DB" Dbordemcompraitem'
      '   ON  (Dbordemcompra.Filial = Dbordemcompraitem.Filial)  '
      '   AND  (Dbordemcompra.Codigo = Dbordemcompraitem.Codigo)  '
    ...
    object qOrdemReferencia: TStringField
      FieldName = 'Referencia'
    end
    ...
    object qOrdemTamanho: TStringField
      FieldName = 'Tamanho'
      Size = 10
    end
    object qOrdemQtdCancelada: TFloatField
      FieldName = 'QtdCancelada'
      DisplayFormat = '###,###,##0.00000'
    end
