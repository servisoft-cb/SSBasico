    ...
    0 : begin
          Case RadioGroup1.ItemIndex of
            0 : begin
                  ...
                  DM1.tEstoqueMatMov.Filter   := 'DtMov >= '''+DateEdit1.Text+''' and DtMov <= '''+DateEdit2.Text+''' and ES = ''E'' and CodMaterial = '''+
                                                 IntToStr(RxDBLookupCombo1.KeyValue)+''' and CodCor = '''+IntToStr(vCodCor)+'''';
