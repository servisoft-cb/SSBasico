...
uses UDM1, UPedido, UDMMovPedido;
...
begin
  ...
  while not DM1.tPedidoGrade.Eof do
    begin
      ...
      mTamanhoQtdParesCanc.AsFloat := DM1.tPedidoGradeQtdParesCanc.AsFloat;
...
begin
  ...
  try
    if (DM1.tPedidoItemQtdParesFat.AsInteger <= 0) and (DM1.tPedidoItemQtdParesRest.AsInteger <= 0) then
    begin
    ...
    on E: Exception do
    begin
      ShowMessage('Não foi possível excluir MOVPEDIDO, ' + E.Message + '! Clique para continuar!');
    end;
  end;
