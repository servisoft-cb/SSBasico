...
begin
  ...
  RLLabel24.Caption := '';
  if fPrevPedCarteira.RxDBLookupCombo1.Text <> '' then
    RLLabel24.Caption := RLLabel24.Caption + ' Filial: ' + fPrevPedCarteira.RxDBLookupCombo1.Text;
...
procedure TfRelPedCarteira.RLBand2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  RLBand2.Color := fPrevPedCarteira.mProdutoCorBanda.AsInteger;
end;
