...
begin
  ...
  if fConsPedidoBR.RxDBLookupCombo5.Text <> '' then
    RLLabel2.Caption := RLLabel2.Caption + '(Fabrica: ' + fConsPedidoBR.RxDBLookupCombo5.Text + ') ';
  ...
  fConsPedidoBR.vDescOpcaoImp := RLLabel2.Caption;
end;
...
begin
  if fConsPedidoBR.CheckBox2.Checked then
    RLSubDetail2.DataSource := fConsPedidoBR.dsPedidoNota
  else
...
begin
  ...
  begin
    RLDBText9.DataField  := 'DtEmbarquePed';
    RLDBText19.DataField := 'DtProducaoPed';
  end;
end;
...
begin
  ...
  for i := 1 to 20 do
    begin
      ...
      TRLLabel(FindComponent('Fat'+IntToStr(i))).Visible  := False;
      TRLLabel(FindComponent('Pend'+IntToStr(i))).Visible := False;
    end;
        ...
        begin
          ...
          if i > 20 then
            ...
            begin
              ...
              TRLLabel(FindComponent('Fat'+IntToStr(i))).Visible  := True;
              TRLLabel(FindComponent('Pend'+IntToStr(i))).Visible := True;
              ...
              TRLLabel(FindComponent('Fat'+IntToStr(i))).Caption  := fConsPedidoBR.tPedidoGradeQtdParesFat.AsString;
              TRLLabel(FindComponent('Pend'+IntToStr(i))).Caption := fConsPedidoBR.tPedidoGradeQtdParesRest.AsString;
            end;
        end;
...
procedure TfRelPedidoBR2.RLBand6BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  RLLabel31.Caption := fConsPedidoBR.vDescOpcaoImp;
end;
