...
type
  ...
  private
    vTotalVenda, vTotalMObra, vTotalGeral, vTotalDev : Real;
...
begin
  ...
  RLLabel3.Caption := '';
  if fPrevContrFat.RxDBLookupCombo1.Text <> '' then
    RLLabel3.Caption := 'Filial: ' + fPrevContrFat.RxDBLookupCombo1.Text;
...
begin
  ...
  RLLabel35.Caption := FormatFloat('###,###,###,##0.00',vTotalDev);
end;
...
begin
  ...
  if PrintIt then
    begin
      ...
      RLLabel34.Caption := FormatFloat('###,###,###,##0.00',vTotalDev);
    end;
end;
...
begin
  ...
  vTotalDev   := fPrevContrFat.mAcumuladoVlrAcumDev.AsFloat;
end;
