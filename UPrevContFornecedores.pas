...
uses URelContFornecedores, UDM1;
    ...
    begin
      ...
      if i > 12 then
        ...
        begin
          ...
          qControle.SQL.Add('WHERE  (Dbcpagarparc.DtVencCPagar between :Data1 and :Data2) and (Dbcpagarparc.Filial = :Filial) ');
          ...
          qControle.Params[2].AsInteger := RxDBLookupCombo1.KeyValue;
          qControle.Open;
          qControle.First;
