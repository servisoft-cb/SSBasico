...
var
  fTipoIndicacao: TfTipoIndicacao;
  vExcluir : Boolean;
...
procedure TfTipoIndicacao.Excluir_Registro;
begin
  DM1.tCadastroSimples.Delete;
end;

procedure TfTipoIndicacao.Habilita;
begin
...
procedure TfTipoIndicacao.BitBtn6Click(Sender: TObject);
begin
  Close;
end;

procedure TfTipoIndicacao.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TfTipoIndicacao.BitBtn1Click(Sender: TObject);
begin
  if DM1.tUsuarioInsTipoIndicacao.AsBoolean then
    begin
      BitBtn2.Tag := 0;
      ...
      DM1.tCadastroSimplesTipo.AsString    := 'IND';
...
procedure TfTipoIndicacao.BitBtn5Click(Sender: TObject);
begin
...
procedure TfTipoIndicacao.BitBtn4Click(Sender: TObject);
begin
...
procedure TfTipoIndicacao.BitBtn2Click(Sender: TObject);
begin
  if DM1.tUsuarioAltTipoIndicacao.AsBoolean then
    begin
      DM1.tCadastroSimples.Edit;
      BitBtn2.Tag := 1;
      Habilita;
...
procedure TfTipoIndicacao.BitBtn3Click(Sender: TObject);
begin
  if DM1.tUsuarioExcTipoIndicacao.AsBoolean then
    begin
      vExcluir := True;
      if vExcluir then
...
procedure TfTipoIndicacao.FormShow(Sender: TObject);
begin
  DM1.tCadastroSimples.Open;
  RxDBFilter1.Active := True;
end;

procedure TfTipoIndicacao.Panel2Enter(Sender: TObject);
begin
  qCadastroSimples.Close;
  qCadastroSimples.Open;
end;

procedure TfTipoIndicacao.RxDBLookupCombo1Change(Sender: TObject);
begin
