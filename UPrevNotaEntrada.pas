...
begin
  ...
  qNotaEntradaGrade.Params[3].AsInteger := qNotaEntradaFilial.AsInteger;
...
begin
  ...
  qNotaEntrada.SQL.Add(' Dbnentrada.DtEntrada, Dbfornecedores.NomeForn, DbNEntradaItens.Item, DbNEntradaItens.VlrTotalItens, Dbnentrada.Filial');
  ...
  qNotaEntrada.SQL.Add('WHERE  (Dbnentrada.DtEntrada BETWEEN :D1 AND :D2) and (Dbnentrada.Filial = :Filial) ');
  ...
  if RxDBLookupCombo1.Text <> '' then
    qNotaEntrada.Params[3].AsDate := RxDBLookupCombo1.KeyValue;
  qNotaEntrada.Open;
